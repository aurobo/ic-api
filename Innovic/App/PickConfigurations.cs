        ...
        private static List<Pick> DefaultData
        {
            get
            {
                return new List<Pick>
                {
                    ...
                    new Pick("Links", new PickConfig(false, true, new List<Pick>()
                    {
                        new Pick("PurchaseRequest", new PickConfig(false, true, new List<Pick>()
                        {
                            new Pick("Key"),
                            new Pick("Id")
                        })),
                        new Pick("GoodsIssue", new PickConfig(false, true, new List<Pick>()
                        {
                            new Pick("Key"),
                            new Pick("Id")
                        })),
                        ...
                        new Pick("PurchaseOrder", new PickConfig(false, true, new List<Pick>()
                        {
                            new Pick("Key"),
                            new Pick("Id")
                        })),
                         new Pick("GoodsReceipt", new PickConfig(false, true, new List<Pick>()
                        {
                            new Pick("Key"),
                            new Pick("Id")
                        }))
        ...
        public static PickConfig PurchaseOrder
        {
            get
            {
                return new PickConfig(true, true, new List<Pick>(DefaultData)
                {
                    ...
                    new Pick("PurchaseRequests", new PickConfig(true, true)),
                    new Pick("GoodsReceipts", new PickConfig(true, true))
                });
            }
        }
